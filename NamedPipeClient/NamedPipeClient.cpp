...
//#define __using_call_named_pipe__
...
int _tmain( int argc, TCHAR *argv[] )
{
...
#ifdef __using_call_named_pipe__
	...
	DWORD cbRead;
	_putts( _T( "Calling CallNamedPipe()" ) );
	auto fSuccess = CallNamedPipe(
			pipeName,        // pipe name 
	...
	if( fSuccess || GetLastError() == ERROR_MORE_DATA )
	{
		...
		{
			_putts( _T( "" ) );
			_putts( _T( "Extra data in message was lost." ) );
		}
	}
	_getch();
#else
